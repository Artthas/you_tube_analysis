...
main_channel = 'thefugitiveofficial'
comp_list = ['ocgtvofficial', 'thefbifiles', 'deathdoor4687', 'courtroomconsequences', 'realcrime', 'streetcrimeuk', 'truecrimetelevision', 'killerchronicles', 'discoverize']
import os
import time
import logging
import openai
...
#
# d = asyncio.run(create_ideas_by_channal(dict_with_all_videos=dict_for_test, main_channel_name=main_channel, competitors_list=comp_list))
#
...
# d = asyncio.run(find_concurence(dict_with_all_videos=dict_for_test, main_channel_name=main_channel))
#
# print(d)