...
async def get_keywords(text_array):
    ...
    completion = await openai.ChatCompletion.acreate(
        ...
        messages=[
            ...
            {"role": "user",
             "content": f"I will provide you with a list of YouTube video titles. Based on these titles, you need to understand the channel's content and niche and create 6 - 8 keywords to search for the most relevant videos on YouTube and write all the keywords in a single line, separated by a vertical bar (|):\n\n\n\n{text}"}
